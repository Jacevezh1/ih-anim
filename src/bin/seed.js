// ARCHIVO INDEPENDIENTE (No se conecta con ninguno otro)(Poblar base de datos)
...
const generateAnimes = async() => {
    ...
    mongoose.connection.close() // Cerrar la conexion, por seguridad
}
